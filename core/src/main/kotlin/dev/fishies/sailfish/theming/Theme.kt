...
package dev.fishies.sailfish.theming
...
import dev.fishies.sailfish.util.fromHtmlColor
import dev.fishies.sailfish.util.toHtmlColor
...
data class Theme(
    ...
    object ColorSerializer : KSerializer<Color> {
        override val descriptor: SerialDescriptor
            get() = PrimitiveSerialDescriptor("dev.fishies.sailfish.theming.Theme.ColorSerializer", PrimitiveKind.STRING)
